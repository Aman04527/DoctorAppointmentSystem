            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  ...
                  praesentium eaque exercitationem delectus perferendis illo
                  itaque velit voluptas. Reiciendis eum neque tempora ullam
                  delectus, dolorem ad enim? Aspernatur, illum aliquam.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[px]">
                ...
                <Link
                  to="/doctors"
                  className="w-[44px] h-[44px] rounded-full border border-solid boder-[#181A1E] mt-[30px] 
