...
import {
  ...
  AiOutlineInstagram,
  AiFillLinkedin,
} from "react-icons/ai"; // Correct the import here

const socialLinks = [
  {
    path: "https://studio.youtube.com/channel/UCTkArDCptF9alkd0T1x70sA",
    icon: <AiFillYoutube className="group-hover:text-white w-4 h-5" />,
  },
  {
    path: "https://github.com/Aman04527?tab=repositories",
    icon: <AiFillGithub className="group-hover:text-white w-4 h-5" />,
  },
  {
    path: "https://www.instagram.com/amanjha7845/",
    icon: <AiOutlineInstagram className="group-hover:text-white w-4 h-5" />,
  },
  {
    path: "https://www.linkedin.com/in/aman-jha-2188611b7/",
        ...
        <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px]">
          <div>
            ...
            <p className="text-[16px] leading-7 font-400 text-textColor mt-4">
              Copyright &copy; {year} developed by Aman Jha all rights reserved.
            </p>
